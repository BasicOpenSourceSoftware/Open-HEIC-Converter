OHC will ask for a filepath to pull heic images from then for a filepath to save them to. Once you select it, OHC will convert and save every HEIC image in the folder and tell you if any files failed.
